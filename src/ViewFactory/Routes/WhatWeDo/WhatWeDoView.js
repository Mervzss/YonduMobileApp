        ...
        return (
            <View style={styles.container}>
                                ...
                                return (
                                    ...
                                    <View key={index} style={styles.itemContainer}>
                                        <View style={styles.withIcon}>
                                            <Icon style={{ paddingLeft: responsiveWidth(40) }} 
                                            name={val.icon} 
                                            size={35} />

                                            <Text style={styles.headTextStyle}>{val.headname}</Text>
                ...
                <View style={styles.lowerButton}>
                    <YonduButton title="Get a Quota" 
                    buttonPress={() => this.props.navigation.navigate('RInqure', { title: 'Get a Quote', data: whatWeDo.child })} 
                    color={'#66CC99'} />
                </View>
...
const styles = StyleSheet.create({
    ...
    contentStyle:{ 
        fontSize: 18, 
        paddingLeft: responsiveWidth(75), 
