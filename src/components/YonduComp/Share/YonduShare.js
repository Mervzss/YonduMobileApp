...
export default class YonduShare extends Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false
...
const REACT_ICON = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAIAAAACACAYAAADDPmHLAAAd4klEQVR42u1dCZgU1bUuN/KyuDwx'